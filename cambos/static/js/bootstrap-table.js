...
!function ($) {
    ...
    BootstrapTable.DEFAULTS = {
        ...
        pageNumber: 1,
        pageSize: 25,
        pageList: [5,10, 25, 50, 100, 150, 200, 250, 300, 400],
        search: false,
        ...
        formatLoadingMessage: function () {
            return 'Carregando, favor aguarde…';
        },
        formatRecordsPerPage: function (pageNumber) {
            return sprintf('%s itens por página', pageNumber);
        },
        formatShowingRows: function (pageFrom, pageTo, totalRows) {
            return sprintf(' %s a %s de %s linhas', pageFrom, pageTo, totalRows);
        },
        formatSearch: function () {
            return 'Pesquisa';
        },
        formatNoMatches: function () {
            return 'Não há infomações na busca';
        },
